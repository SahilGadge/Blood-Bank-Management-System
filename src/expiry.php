...
class MyDB extends SQLite3{
	   ...
	   echo $db->lastErrorMsg();}
			...
			echo '<table class="table-fill"><thead><th class="text-left">Sr</th><th class="text-left">CollectionDate</th><th class="text-left">BagID</th><th class="text-left">Group</th><th class="text-left">Product</th><th>ExpiryDate</th></thead><tbody class="table-hover">';
	     while($r=$result3->fetchArray(SQLITE3_ASSOC)){
			...
			$result3=$db->query($sql3);
			echo"<br>"."<h1>Other Bag Near Expiry</h1>";
