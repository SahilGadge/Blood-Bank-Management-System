...
<body>
<form action="seadelete.php" method="GET">
...
class MyDB extends SQLite3{
	   ...
	   echo $db->lastErrorMsg();}
			...
			echo '<tr><td class="text-left">'.$r["bsr"].'</td><td class="text-left">'.$r["bdate"].'</td><td class="text-left">'.$r["bno"].'</td><td class="text-left">'.$r["gp"].'</td><td class="text-left">'.$r["pd"].'</td><td class="text-left">'.$r["ino"].'</td><td class="text-left">'. $r["idate"].'</td><td class="text-left">'. $r["pn"]."</td><td><a href='deletep.php?b=$d'>Delete</a></td></tr>";
			...
			echo "<a href='deletep.php?b=$d'>Delete</a></td></tr>";
			}
			echo"</table>";
		}}
}
