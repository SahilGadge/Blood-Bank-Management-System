...
</div><td id="t1"><input type="submit" value="Search" class='button'></td></tr></table>
</form>
...
class MyDB extends SQLite3{
	   ...
	   echo $db->lastErrorMsg();}
			...
			echo '<tr><td class="text-left">'.$r["bsr"].'</td><td class="text-left">'.$r["bdate"].'</td><td class="text-left">'.$r["bno"].'</td><td class="text-left">'.$r["gp"].'</td><td class="text-left">'.$r["pd"].'</td><td class="text-left">'.$r["ino"].'</td><td class="text-left">'. $r["idate"].'</td><td class="text-left">'. $r["pn"].'</td><td class="text-left">'. $r["ho"].'</td><td class="text-left">'. $r["col"]."</td></tr>";
			}
            echo"</tbody></table>"	;}
			else{
			$sql1 = "SELECT * from blood where bno='$s'";
			echo"<h2>Successful...Details are !!</h2>";
