...
class MyDB extends SQLite3{
	   ...
	   echo $db->lastErrorMsg();}
			...
			echo '<tr><td class="text-left">'.$r["bsr"].'</td><td class="text-left">'.$r["bdate"].'</td><td class="text-left">'.$r["bno"].'</td><td class="text-left">'.$r["gp"].'</td><td class="text-left">'.$r["pd"].'</td><td>'.$r["col"]."</td></tr>";
			$i++;}
